...
import { buildRecommendationPipeline } from "../../services/recommendations/pipeline";
...
export function Dashboard({ onNavigate, onQuickAdd, gc, secureCalendar, deps }) {
  ...
  const intelligence=useMemo(()=>buildRecommendationPipeline(recommendationData,{history:recommendationHistory.data,today:TODAY_STR,settings:{sensitivity:aiSettings.recommendationSensitivity}}),[TODAY_STR,aiSettings.recommendationSensitivity,recommendationData,recommendationHistory.data]);
