...
The corresponding migration is `20260712000000_release_2_2_pool_optional_text_nulls.sql`. Renaming the legacy date-only version normalized Supabase ordering only; its SQL and the Pool data contract are unchanged.
