...
## Sprint Goal
Complete Release 0.6A by migrating Family OS from Create React App to Vite while preserving existing behavior.
...
## Blockers
- Signed-in visual verification remains blocked until a valid local authenticated session is available in the browser.
