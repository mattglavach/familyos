-- LOCAL-ONLY MIGRATION - DO NOT APPLY TO PRODUCTION
-- Family OS household-centered architecture foundation migration.
-- Copied from the revised, validated draft on 2026-06-28.
--
-- This file establishes the initial Supabase migration folder for local-only
-- household foundation testing. Do not apply this migration to production until
-- local dry-run results and production readiness are reviewed.
--
-- Source baseline:
